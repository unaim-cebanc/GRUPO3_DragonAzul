Base de datos:
- Ha habido un problema, unai borró sinquerer mi rama, entonces los commits son de ahora mismo, pero llevo días haciendolo.
- Primero creamos una base de datos en papel, entonces como primera demo, hice en draw.io.
